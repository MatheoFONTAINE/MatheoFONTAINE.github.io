...
const filterSystem = {
    ...
    handleSelection: function (event) {
        ...
        document.querySelectorAll('.project-list article').forEach(project => {
            const isGameEngineValid = project.dataset.engine === gameEngineSelectElm.value || gameEngineSelectElm.selectedIndex === 0;
            const isLanguageValid = project.dataset.language === languageSelectElm.value || languageSelectElm.selectedIndex === 0;
            const isPlatformValid = project.dataset.platform === platformSelectElm.value || platformSelectElm.selectedIndex === 0;
